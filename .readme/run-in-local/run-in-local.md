...
```
docker exec -it geth_poa_1 bash
cp /geth_bin/39.105.18.23--0x85564bfb7d913cc7ca84f3b325cdf239b950c3f5.json   /geth_data/keystore/

docker exec -it geth_poa_2 bash
cp /geth_bin/39.105.153.126--0xc65bc7f6de6c366d48d531d57bb7f41d79a63a69.json /geth_data/keystore/
...
admin.addPeer("enode://3bdfa43690d2038aa682a5d4b760985e175654d0716c36b10dcfc5785ee476ba5729d70fc4577013f55764eca6f63310da264b35eef78b1e2e8abad7164474e4@172.19.0.2:30303?discport=0")
admin.addPeer("enode://c292286777090a6116ba6cc3de7f47f7b16c0b00ef2abc2b6748f40f33a5a346b0f317686e7a42288a447ead1d2c6265d7ecab9334c84cd9f38bf87144f921d1@172.19.0.3:30303?discport=0")
admin.addPeer("enode://945eb6d6bd1697ecf0d121c4413d8b640de54c0b50a5c6fddffba5a5ba20da8256f919139f56f2cd076a01268d280f81e0b5f4a4ffd1545ae1919f80ddc23b15@172.19.0.4:30303?discport=0")
admin.addPeer("enode://4f4ed5e2c818617fd04b514cd16630303a88a634256a3b6a4786c4f302aff9552677030b32f982c7e751cd33af5e59411d11aa3270dd51395f80e71ea5d951c4@172.19.0.5:30303?discport=0")
net.peerCount
admin.peers # 查看邻居节点
```
