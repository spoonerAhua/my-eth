...
import (
	...
	"github.com/spoonerAhua/my-eth/crypto/signify"
	"github.com/spoonerAhua/my-eth/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/spoonerAhua/my-eth/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/spoonerAhua/my-eth/mobile")
